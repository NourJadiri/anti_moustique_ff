...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => const DevicePageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => const DevicePageWidget(),
        ),
        FFRoute(
          name: 'DevicePage',
          path: '/devicePage',
        ...
        FFRoute(
          name: 'ControlePage',
          path: '/controlePage',
          builder: (context, params) => const ControlePageWidget(),
        ),
        FFRoute(
          name: 'MapPage',
          path: '/mapPage',
        ...
        FFRoute(
          ...
          path: '/addSchedulePage',
          builder: (context, params) => const AddSchedulePageWidget(),
        )
